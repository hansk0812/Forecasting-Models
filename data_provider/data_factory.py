...
from data_provider import Dataset_Weather, Dataset_Yahoo_Finance, Dataset_AG_Delhi, Dataset_NIFTY
from data_provider import Dataset_PEMS_Traffic
...
def data_provider(args, flag):
    ...
    if args.data == "Dataset_Weather_Stations_ALL":
        data_set = Data(
            ...
            select_variates=args.select_variates
        )
        print(flag, len(data_set), 'self')
        print ("Dataset %s has timestamps of interval: " % args.data, data_set.frequency())
